        ...
        try {
            ...
            if (createForm.leave_type === 'annual' || createForm.leave_type === 'sick') {
                ...
                if (createForm.leave_hours > availableHours) {
                    const leaveTypeName = createForm.leave_type === 'annual' 
                        ? t('leaveTypeAnnual') 
                        : t('leaveTypeSick');
                        ...
                        {filteredRequests.map((request, index) => (
                            <div key={index} className="request-card">
                                <div className="request-header">
                                    <div className="employee-info">
                                        <div className="employee-avatar">
                                            {request.staff ? request.staff[0].toUpperCase() : '?'}
                                        </div>
                                ...
                                <div className="request-actions">
                                    ...
                                    {/* 取消按鈕 - 只有自己的申請且狀態為 pending 或 approved 才顯示 */}
